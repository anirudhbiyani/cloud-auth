...
func TestCredentialProcessJSON(t *testing.T) {
	...
	creds := &core.Credentials{
		Cloud: core.AWS, AccessKeyID: "AKIA", SecretAccessKey: "sk", SessionToken: "st", Expiry: exp,
	}
...
func TestFormatEnvAWS(t *testing.T) {
	creds := &core.Credentials{Cloud: core.AWS, AccessKeyID: "AKIA", SecretAccessKey: "sk", SessionToken: "st"}
	out := formatEnv(creds)
...
func TestFormatEnvBearer(t *testing.T) {
	creds := &core.Credentials{Cloud: core.GCP, AccessToken: "tok"}
	out := formatEnv(creds)
